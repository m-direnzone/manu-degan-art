  ...
  return (
    <div>
      <Grid container px={isMobileDevice ? "6%" : "2%"} py={"4%"}>
        ...
        <Grid item container xl={12} xs={12} mt={isMobileDevice ? "12%" : "2%"}>
          <Typography
          ...
          <Grid item xs={12} xl={9}>
            <Typography className="paragraph" mt={"0.5%"}>
              ...
              2020 - 7° {t("edizione")} {t("mostra-internazionale")} “Donna
              oggi” Premio Sergio Manzi a San Gimignano.{" "}
              <strong>3° {t("posto")}</strong>, {t("occhi-di-luna")} 100 x 70
              cm. <br /> 2020 - VII {t("edizione")}{" "}
              {t("nuovi-occhi-sul-mugello")}. <br /> 2021 - {t("arte-e-natura")}{" "}
              Campugliano (Pt) <strong>3° {t("posto")}</strong>,{" "}
              {t("penna-biro")}
              ...
              <strong>3° {t("posto")}</strong>, {t("angelo-di-luce")}. <br />{" "}
              2023 - IX {t("premio-internazionale")} Acipea,{" "}
              {t("premio-san-valentino")}. <br /> 2023 - 55°{" "}
              {t("premio-enrico-caruso")} <br />
              {t("carta-modigliani")}, 100 x 70 cm <br />
              2024 - X {t("premio-internazionale")} Acipea,{" "}
              {t("premio-passione-innamorata")}. <br />
              2024 - {t("premio-internazionale")}{" "}
              {t("nuovi-occhi-sul-mugello-titolo")} {t("firenze")}{" "}
